...
public class Test {
	...
	public static void main(String[] args) 
	{
		...
		//course.registerStudent(student11);  //to check max number of students that can be registered -- will throw exception
		
		course2.registerStudent(student1);
		
		System.out.println("Is the registration full for " +course.getName() + "? " +course.isFull());
		System.out.println("Is the registration full for " +course2.getName() + "? "+course2.isFull());
		...
		System.out.println("Printing list of students in "+course.getName());
		...
		System.out.println("Printing list of students in "+course2.getName());
		System.out.println("NAME, ID");
		for(int i = 0; i< course2.getNumberOfStudent() ; i++)
		{
			System.out.println(stud[i].getName() + ", "+ stud[i].getId());
		}
